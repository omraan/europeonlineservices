<?php
namespace Sunflowerbiz\Wechat\Model\Ui;
 ...
 */
class SunWechatConfigProvider implements ConfigProviderInterface
{
      ...
      /*  $merchant_id = $this->method->getConfigData('merchant_id');
        ...
        return [
            'payment' => [
                self::CODE => [
                    'isActive' => true,
                    'redirectUrl' =>$this->_urlBuilder->getUrl('wechat/process/redirect')
                ]
            ]
        ];
    }
